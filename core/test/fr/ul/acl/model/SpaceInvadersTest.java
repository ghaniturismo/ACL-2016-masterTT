...
public class SpaceInvadersTest {
	...
	//Test le mvt vers le bas dans le cas ou l'on est tous en bas (pas de mvt normalement)
		@Test
	...
	//Test le mvt vers le haut dans le cas ou l'on est tous en haut (pas de mvt normalement)
	@Test
	public void shipUp2(){
        float tmp1 = delta * speed;
		World w = new World();
