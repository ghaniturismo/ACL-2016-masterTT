...
public class ShipTest {
	...
	// pas de mvt normalement , il doit rester � sa position
	@Test
	...
	// on verifie si y'a bien la d�tection de la collision entre l'alien et la fusee  et la maj du nbre de vie
	//on recupere la vie avant collision on soustrait 1 et on teste si c'est la meme que celle apres la collison
		...
		//on verifie qu on met bien � jour le level quand on atteint 1000 points
